...
3. I recovered the theta values $\theta$ used as input for the simulations from the file `/n/home07/gthomas/projects/phyloacc/Yan-etal-2022/data/SimulatedData/neut_ver3_genetree2.named.mod`, as the number following the `#` symbol in the branch lenghts in the provided tree:
