...
You can catch problems before you use the data in later analyses.</code></pre>
            ...
            <div class="row" id="section-header-cont">
                <div class="col-24-24" id="section-header-row">
                    <div id="section-header">Installing PhyloAcc</div>
                </div>
            </div>
            <div class="row" id="section-cont">
                <div class="col-24-24" id="section-col">
                ...
                <div class="col-24-24" id="section-col">
                    <div class="row" id="section-row">
                        ...
                        <div class="col-20-24" id="section-content">                       
                            ...
                            <center><pre class="cmd"><code>module load python</code></pre></center>
                            ...
                            <div class="table-cont">
                                <table class="cmd-table">
                                    ...
                                    <tr>
                                        <td class="tcol-1">python</td>
                                        <td class="tcol-2">The name of the package we want to load.</td>
                                    </tr>                                    
                                </table>
                            </div>

                            <p>Next, create an environment in which to install PhyloAcc</p>
                            ...
                            <div class="table-cont">
                                <table class="cmd-table">
                                    <thead><th class="tcol-1">Command line parameter</th><th class="tcol-2">Description</th></thead>
                                    <tr>
                                        <td class="tcol-1">mamba</td>
                                        <td class="tcol-2">The mamba sofware management program.</td>
                                    </tr>
                                    <tr>
                                        <td class="tcol-1">create</td>
                                        <td class="tcol-2">The mamba command to create an environment.</td>
                                    </tr>
                                    <tr>
                                        <td class="tcol-1">-n phyloacc-env</td>
                                        <td class="tcol-2">The option to name the environment. You can give it any name you want. Here we chose 'phyloacc-env'.</td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div class="table-cont">
                                <table class="cmd-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tcol-2">The mamba command to activate an environment.</td>
                                    </tr>
                                    <tr>
                                        <td class="tcol-1">phyloacc-env</td>
                                        <td class="tcol-2">The name of the environment to activate.</td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <center><pre class="cmd"><code>mamba install bioconda::phyloacc</code></pre></center>
                            ...
                            <div class="table-cont">
                                <table class="cmd-table">
                                    ...
                                    <tr>
                                        <td class="tcol-1">install</td>
                                        <td class="tcol-2">The mamba command to install a package.</td>
                                    </tr>
                                    <tr>
                                        <td class="tcol-1">bioconda::phyloacc</td>
                                        <td class="tcol-2">The name of the package to install, with the bioconda channel specified.</td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <center><pre class="cmd"><code>phyloacc --depcheck</code></pre></center>

                            <div class="table-cont">
                                <table class="cmd-table">
                                    <thead><th class="tcol-1">Command line parameter</th><th class="tcol-2">Description</th></thead>
                                    <tr>
                                        <td class="tcol-1">phyloacc</td>
