		...
		<div class="col-18-24" id="main-content-col">
				...
				<div class="row" id="install-row">
					...
					<div class="col-20-24" id="install-col">
						...
						<p>
							For those with the most up to date version of conda and mamba installed, you can 
						...
						<div id="install-cont">
							<code>mamba install phyloacc</code>
						</div>
							...
							<div class="col-20-24" id="title-col">
								<center>
									<a href="https://bioconda.github.io/recipes/phyloacc/README.html" target="_blank">
										...
										<img src="https://img.shields.io/badge/Linux%2CWSL%2COSX-orange?label=platforms&color=%23fe7d37" />
                                    ...
                                    <a href="https://bioconda.github.io/recipes/phyloacc/README.html#download-stats" target="_blank">
										<img src="https://img.shields.io/conda/dn/bioconda/phyloacc.svg?style=flat" />
                                    </a>                                    
									<a href="https://github.com/phyloacc/PhyloAcc/commits/main/" target="_blank">
										<img src="https://img.shields.io/github/commits-since/phyloacc/PhyloAcc/v2.3.1" />
									</a>
                                    <a href="https://github.com/phyloacc/PhyloAcc/blob/main/LICENSE.md" target="_blank">
											<img src="https://img.shields.io/badge/GPL%203.0%2B-black?label=license&color=%23333333" />
									</a>
								</center>
							</div>
							<div class="col-2-24 margin"></div>
