                ...
                <div class="col-24-24" id="section-col">
                    <div class="row" id="section-row">
                        ...
                        <div class="col-20-24" id="section-content">
                            ...
                            <p>
                                All other parameters are optional or have default values. Options can be specified in the command line or in a config file. While they are optional, 
                            ...
                            <div class="table-container">
                                <table class="table-content">
                                    ...
                                    <tr>
                                        <td>
                                            <code class="inline">--config [YAML FILE]</code>
                                        </td>
                                        <td>
                                            <code class="inline">NA</code>
                                        </td>                                        
                                        <td>
                                            The path to a YAML formatted configuration file that specifies the program options (see above). 
                                            Note that options specified on the command line take precedence of those specified in the config file.
                                        </td>
                                        <td>
                                            Optional
                                        </td>                                        
