                ...
                <div class="col-24-24" id="section-col">
                    <div class="row" id="section-row">
                        ...
                        <div class="col-20-24" id="section-content">
                            ...
                            <p>
                                Marginal log-likelihood for all models (integrating out parameters and latent states).
                            </p>
                            ...
                            <div class="table-container">
                                <table class="table-content">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            Marginal log-likelihood under the null model
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            Marginal log-likelihood under accelerated model
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            Marginal log-likelihood under the full model
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            log Bayes factor between null and accelerated model
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            log Bayes factor between accelerated and full model
                                        </td>
                                    </tr>                                                                                                                                                                                                        
                                    <tr>
                                        <td>
                        ...
                        <div class="col-20-24" id="section-content">
                            ...
                            <div class="table-container">
                                <table class="table-content">
                                    ...
                                    <tr>
                                        <td>
                                            <code class="inline">-path [STRING]</code>
                                        </td>
                                        <td>
                                            The path to the PhyloAcc binary.
                                        </td>
                                        <td>
                                            PhyloAcc
                                        </td>                                        
