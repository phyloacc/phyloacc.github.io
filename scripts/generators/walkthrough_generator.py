                    ...
                    <ul>
                        <li><a href="walkthrough.html#scratch">Starting from scratch</a></li>
                            <ol>                        
                                ...
                                <li><a href="walkthrough.html#wga">Generating a whole-genome alignment</a></li>
                                <li><a href="walkthrough.html#cnee-neutral-model">Generating conserved elements and a neutral model</a></li>
                            </ol>
                    </ul>
                ...
                <div class="col-24-24" id="section-col">
                    <div class="row" id="section-row">
                        ...
                        <div class="col-20-24" id="section-content">
                            ...
                            <h4>High level flowchart of preparing inputs and running PhyloAcc</h4>
                            ...
                            <p>
                                If starting from scratch, in other words if you need to infer the conserved elements and neutral model yourself, you will need the following inputs:
                            </p>
                            ...
                            <p>
                                You will typically start by generating a whole-genome alignment (WGA) of the species you wish to analyze.
                            </p>

                            <a class="internal-link" id="species-tree"></a>
                            <h3>1. A note on the species tree</h3>

                            <p>
                                We don't currently provide guidance on inferring or acquiring a species tree since there are many ways to do so. However, a topology is
                                required for the WGA step and inferring the neutral model. 
                            </p>
                            ...
                            <p>
                                We hope to provide more guidance on this in the future.
                            </p>
                            ...
                            <p> 
                                ...
                                our
                                <a href="https://informatics.fas.harvard.edu/resources/tutorials/whole-genome-alignment-cactus/" target="_blank">Cactus alignment tutorials</a>
                                for a walkthrough.
                            </p>
                            ...
                            <p>
                                ...
                                conservation with <code class="inline">phastCons</code>, and extracting a final set of CNEE alignments &mdash; the
                                loci and neutral model PhyloAcc needs.
                            </p>
                    ...
                    <div class="row" id="section-row">
                        ...
                        <div class="col-20-24" id="section-content">
                            ...
                            <p>
                                ...
                                workflow above &mdash; head to the README for installing and running <code class="inline">PhyloAcc</code> itself,
